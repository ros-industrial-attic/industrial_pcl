...
public:
  ...
  void CalculatePumpOrientation()
  {
     ...
     */
    createCircularFilters();
    createDilationElement(3);
  ...
  void createCircularFilters()
  {
    try
    {
       ...
       */
      large_circle_filter = createHoughCircles(large_circle_radius, circle_large_variation);
      small_circle_filter = createHoughCircles(small_circle_radius, circle_small_variation);
    }
    catch(int a)
    {
  ...
  void createDilationElement(int sz)
  {
    try
    {
       ...
       */
      dilation_element = getStructuringElement(MORPH_RECT, Size(sz,sz));
    }
    catch(int a)
    {
  ...
  bool processPumpImage(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    imshow(WINDOW2,binary_Removed_Img);
    waitKey(100);
    ...
    imshow(WINDOW3, large_circle_located);
    waitKey(100);
    imshow(WINDOW4, small_circle_located);
    waitKey(100);
  ...
  void convolveCircluarFilters_With_PumpImg()
  {
    try
    {
       ...
       */
      large_circle_located = convolveImage(binary_Removed_Img, large_circle_filter);
      small_circle_located = convolveImage(binary_Removed_Img, small_circle_filter);
    }
    catch(int a)
    {
